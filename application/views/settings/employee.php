            ...
            <div class="">
                <div class="row">
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-body ">
                                <a href="<?php echo base_url(); ?>index.php/settings/add_employee"  type="button" class="btn btn-success pull-right ">
                                    Add New Employee
                                </a>
                            </div>
                            <div class="box-body">
                                            ...
                                            <tr>
                                                ...
                                                <td class="center">
                                                    ...
                                                    <span class="btn-group">
                                                        ...
                                                        echo '<a href="#" class="btn btn-block btn-danger" onclick="confirm_delete(' . $employee['id'] . ')" > <i class="fa fa-close"></i> </a>';
                                                        ?>
                                                    </span>
                                                    <?php echo form_close(); ?>
                                                </td>
