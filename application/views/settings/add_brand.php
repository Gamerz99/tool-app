...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Add Brand</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title">please add your brand</h3>
            </div>
            <div class="box-body">
                <?php echo form_open('settings/save_brand', 'id="form1" data-parsley-validate class=""'); ?>
                <div class="row">
                    <div class="col-md-6">
                        ...
                        echo form_input('name', $brand['name'], 'class="form-control"'); ?>
                    </div>
                </div><br>
