...
<div class="content-wrapper" role="main">
    <div class="">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Tool</a></li>
            </ol>
        </section>
            ...
            <div class="">
                <div class="row">
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-body ">
                                <a href="<?php echo base_url(); ?>index.php/settings/add_tool"  type="button" class="btn btn-success pull-right ">
                                    Add New Tool
                                </a>
                            </div>
                            <div class="box-body">
                                            ...
                                            <tr>
                                                ...
                                                <td width="150px" class="center">
                                                    ...
                                                    <span class="btn-group">
                                                        ...
                                                        echo '<a href="#" class="btn btn-block btn-danger" onclick="confirm_delete(' . $tool['id'] . ')" > <i class="fa fa-close"></i> </a>';
                                                        ?>
                                                    </span>
                                                    <?php echo form_close(); ?>
                                                </td>
