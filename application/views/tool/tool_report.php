...
<div class="content-wrapper" role="main">
    <div class="">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Tool Log Report</a></li>
            </ol>
        </section>
...
<script>
    ...
    function load() {
        var table = $('#example4').DataTable({
            "ajax": "<?php echo base_url(); ?>index.php/api/tool_api/tool_log_report",
            "columnDefs": [
                {"width": "1%", "targets": 0}
            ],
            dom: 'Bfrtip',
    ...
    $("#search").click(function () {
        ...
        $('#example4').DataTable({
            "ajax": "<?php echo base_url(); ?>index.php/api/tool_api/tool_log_report/" + datefrom + "/" + dateto ,
            "columnDefs": [
                {"width": "1%", "targets": 0}
            ],
            dom: 'Bfrtip',
